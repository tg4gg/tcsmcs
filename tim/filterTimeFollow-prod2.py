...
ax1.set_ylabel("Time between executions (period)", color="b")
...
#when = datetime.strptime("2018-04-16 12:52", "%Y-%m-%d %H:%M")
#ax1.axvspan(when, when+timedelta(minutes=50), facecolor='0.2', alpha=0.3)
ax2 = ax1.twinx()
