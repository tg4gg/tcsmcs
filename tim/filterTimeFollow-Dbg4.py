...
FollowArray = namedtuple('FollowArray', 'timestamp traw dmdCnt corrCnt tick applyDT fltCnt readSemDt writeSemDt tnow azDmd elDmd dtraw')
...
for dp in flw_producer:
    ...
    exec_lst.append((dp.timestamp, tBetweenTicks*1000.0))
...
# ax8 = plt.subplot(515, sharex=ax1)
